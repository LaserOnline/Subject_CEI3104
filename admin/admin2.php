...
<body>
    ...
    <div class="card" style="width: 30rem;margin-left: 650px;margin-top: -100px">
        <div class="card-body">
            <h1 align="center">รายการซี่รีย์ทั้งหมด</h1>
        ...
        <table class="table table-striped table-hover ">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding-left: 25px;"><?php echo $row_movie['part'] ?></td>
                    <td style="padding-left: 15px;"><a style="text-decoration: none;color: orange;" href="../edit/from_edit2.php?id=<?= $row_movie['id']; ?>">edit</a></td>
                    <td style="padding-left: 1px;"><a style="text-decoration: none;color: red;" href="../delete2.php?id=<?= $row_movie['id']; ?>" onclick="return confirm('ต้องการลบใช่หรือไม่');">Delete</a></td>
